...
function _findOrCreateUser(id, name) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, _findUser(id)];
                case 1:
                    user = _a.sent();
                    if (user) {
                        return [2 /*return*/, user];
                    }
                    return [2 /*return*/, _createUser(id, name)];
            }
        });
    });
}
exports._findOrCreateUser = _findOrCreateUser;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, (0, firebase_snapshot_utils_1.docWithId)(doc)];
            }
        });
    });
}
function _createUser(id, name) {
    return __awaiter(this, void 0, void 0, function () {
        var data;
        return __generator(this, function (_a) {
            switch (_a.label) {
