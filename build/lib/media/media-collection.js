...
exports.getMedia = exports.postMedia = void 0;
var firestore_1 = require("firebase/firestore");
function _collectionPath(channelId) {
    return "/channels/".concat(channelId, "/media");
}
function _collectionRef(channelId) {
    var db = (0, firestore_1.getFirestore)();
    return (0, firestore_1.collection)(db, _collectionPath(channelId));
}
function postMedia(channelId, media) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, firestore_1.addDoc)(_collectionRef(channelId), media)];
...
function getMedia(channelId, after) {
    return __awaiter(this, void 0, void 0, function () {
