...
import { addDoc, collection, getDocs, getFirestore, orderBy, query, startAfter } from 'firebase/firestore';
...
export function postMedia(channelId, media) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, addDoc(_collectionRef(channelId), media)];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
}
export function getMedia(channelId, after) {
    return __awaiter(this, void 0, void 0, function () {
